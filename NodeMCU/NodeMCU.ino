...
const char *ssid = "Chocochip";  //ENTER YOUR WIFI SETTINGS
const char *password = "Lzoncekim72::;";
...
int POST_GET() {
  ...
  //POST Data
    ...
    http.begin(client, "http://192.168.1.15/iot-cloud/getUID.php");  //Specify request destination
...
//  Serial.println(payload);    //Print request response payload
  ...
  delay(2000); //Delay delimitare requesturi
   ...
   HTTPClient http;    //Declare object of class HTTPClient
   http.begin(client, "http://192.168.1.15/Iot_cloud/null.php");  //Specify request destination
   httpCode = http.GET();                                                                  
...
void waktu () {
  ...
  //Crearea unei structuri de waktu
